...
/*
 * Simple benchmark that runs a mixture of point lookups and inserts on AUTODB.
 */

#include "../core/autoDB.h"
...
int main(int argc, char* argv[]) {
  ...
  // Create AUTODB and bulk load
  autoDB::AutoDB<KEY_TYPE, PAYLOAD_TYPE> index;
